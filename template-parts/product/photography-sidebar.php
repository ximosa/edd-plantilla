<?php
/**
 * Template part for displaying photography sidebar
 *
...
<div class="col-md-4">
	<div class="product-description-right">
		...
		if( $eidmart_radio_value1 == 'value_3' ){ ?>
		...
		if ( $eidmart_radio_value4 == 'value_9' ) { 
			...
			<div class="item-rating">
				<p> <b><?php esc_html_e( 'Item Rating:', 'eidmart' ); ?></b>
					<?php                            
					$mreview = new EDD_Reviews;
					$rating = $mreview->average_rating( false );
					if( $rating > 0 ){                                                    
						$mreview->display_average_rating();                                                                                                        
					} else { ?>   
						<?php esc_html_e( 'This item no rated yet.', 'eidmart' ); ?>                                                 
					<?php } ?>
				</p>
			</div>
			<?php 
