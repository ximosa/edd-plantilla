...
/**
 * Template Name: Photography:: Multi Vendor Profile
 *
 * @package eidmart
 **/
				...
				<div class="col-md-4">
					...
					if( $featured_item->have_posts() ):
						...
						<div class="vendor-feature-product vendor-profile">
							...
							<h3><strong><?php if ($edd_price): echo wp_kses_post( $item_price ); else: echo __('Free', 'eidmart'); endif; ?></strong></h3>
						...
						while ( $wp_query->have_posts() ) : 
							...
							<div class="grid-item">
								...
								echo "<div class='auth-info'>"; 
									...
									if ( get_theme_mod( 'eid_sales_con' ) == 'on'): 
