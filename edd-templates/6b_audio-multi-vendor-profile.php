...
/**
 * Template Name: Audio:: Multi Vendor Profile
 *
 * @package eidmart
 **/
		...
		<div class="col-md-12">
			<nav class="navbar navbar-expand-lg navbar-light eidmart-dashboard-menu">
				...
				<?php if( get_theme_mod( 'vendor_message_popup', 1 ) == 1 ): ?>
					...
					<button type="button" class="btn-hover color-primary" data-toggle="modal" data-target="#vendorMessage" data-bs-toggle="modal" data-bs-target="#vendorMessage">
...
<div class="container margin-bottom-large audio-version<?php if( get_theme_mod( 'user_follow' ) == 2 ): echo " margin-top-large"; endif; ?>">
	<div class="row">
				...
				<div class="col-md-4">
					...
					if( $featured_item->have_posts() ):
						...
						<div class="single-product">
							<a href="javascript:void(0);" class="album-poster <?php echo esc_attr($mp3_title); ?>" data-uniqid="<?php echo esc_attr($mp3_title); ?>" data-switch="0" data-price='<?php if ($edd_price): echo wp_kses_post( $item_price ); else: echo __esc_html('Free', 'eidmart'); endif; ?>' data-title='<?php the_title();?>' data-artist="<?php echo esc_attr($mp3_artist); ?>" data-mp3="<?php echo esc_attr($mp3_url); ?>" data-pid="<?php echo esc_attr($id); ?>" data-cover="<?php the_post_thumbnail_url();?>">
							...
							<div class="product-content">
								...
								<?php if( get_theme_mod( 'eid_price_con' ) == 'on' ): ?><div class="price"><?php if ($edd_price): echo wp_kses_post( $item_price ); else: echo __('Free', 'eidmart');endif;?></div><?php endif; ?>
							</div>                            
					...
					<div class="row">
						...
						<?php
							...
							while ( $wp_query->have_posts() ) : 
								...
								<div class="col-md-4">
									<div class="single-product">
										<a href="javascript:void(0);" class="album-poster <?php echo esc_attr($mp3_title); ?>" data-uniqid="<?php echo esc_attr($mp3_title); ?>" data-switch="0" data-price='<?php if ($edd_price): echo wp_kses_post( $item_price ); else: echo esc_html__('Free', 'eidmart'); endif; ?>' data-title='<?php the_title();?>' data-artist="<?php echo esc_attr($mp3_artist); ?>" data-mp3="<?php echo esc_attr($mp3_url); ?>" data-pid="<?php echo esc_attr($id); ?>" data-cover="<?php the_post_thumbnail_url();?>">
											<?php the_post_thumbnail();?>
											<div class="player-icon">
												<i class="las la-play"></i>
												<i class="las la-pause"></i>
