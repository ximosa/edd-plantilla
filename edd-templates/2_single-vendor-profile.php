...
/**
 * Template Name: General:: Single Vendor Profile
 *
 * @package eidmart
 **/
...
if ( isset( $_GET['user'] ) ) {
	...
	<div class="container software-vendor-profile margin-bottom-large<?php if( get_theme_mod( 'user_follow' ) == 2 ): echo " margin-top-large"; endif; ?>">
		<div class="row">
