...
?>
	...
	<div class="latest-product-1x graphicland-profile-product graphicland-style graphicland-one <?php if( get_theme_mod( 'user_follow' ) == 2 ): echo " margin-top-large"; endif; ?>">
		<div class="container">
			<div class="row"> 
