...
/**
 * Template Name: General:: Multi Vendor Profile
 *
 * @package eidmart
 **/
...
if ( $db_user->exists( 'user_id', $user->ID ) ) { ?>
	...
	<div class="container margin-bottom-large<?php if( get_theme_mod( 'user_follow' ) == 2 ): echo " margin-top-large"; endif; ?>">
		<div class="row">
					...
					<div class="col-md-4">
						...
						if( $featured_item->have_posts() ):
							...
							<div class="vendor-feature-product vendor-profile">
								...
								<a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>"><?php echo eidmart_excerpt_char_course_title( '30' ); ?></a>
										...
										<div class="product-details">
											<div class="product-content">
												...
												<h3 class="<?php if ( get_theme_mod( 'sale' ) != 'on'): echo esc_attr( "price-n-preview" ); endif; ?>"> 
													<?php if( get_theme_mod( 'eid_price_con' ) == 'on' ): ?><strong><?php if( $edd_price ): echo wp_kses_post( $item_price ); else: echo __( 'Free','eidmart' ); endif; ?></strong><?php endif; ?>
													<span class="cart-btn">
														<?php if( $edd_price ){ ?>
